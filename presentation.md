...
[^1]: www.digitalneotroctvo.sk

[^2]: www.digitalnasloboda.sk

[^3]: www.samuelpitonak.sk

[^4]: www.cs.wikipedia.org/wiki/Informační_věk

[^5]: www.pokec.sk

[^6]: www.facebook.com

![autoplay loop](assets/digital-innovation-unleashed.mp4)
...
- **technológie stoja v tvojej ceste k pohybu**:
    - tráviš nadmerné množstvo času online zábavou (YouTube, TikTok, Instagram, hry...)
...
![left autoplay loop](assets/wealth-video.mp4)

# [fit] Si digitálny otrok[^1]

- **technológie ti nepomáhajú byť v práci plne sústredeným**:
    - vyrušujú ťa oznámenia z aplikácií, ktoré nie sú relevantné
...
![right autoplay loop](assets/relationships-video.mp4)
...
# [fit] Cesta k<br>digitálnej slobode[^2]
...
![left](assets/digital-native.webp)
...
^ vedenie vsetkych informacii v digitalnej forme
